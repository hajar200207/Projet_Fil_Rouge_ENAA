...
public class PersonneService implements UserDetailsService {
    ...
    public Optional<String> login(String email, String password) {
        ...
        if (personneOpt.isPresent() && passwordEncoder.matches(password, personneOpt.get().getMotDePasse())) {
            ...
            String token = jwtAuth.generateJwtToken(personne);
    ...
    public Optional<Invite> getInviteById(Long inviteId) {
        return Optional.ofNullable(inviteRepository.getInviteById(inviteId));
    }
}